...
export default function SettingsPage() {
  ...
  // Initialize from profile data and localStorage once
  if (profileData?.data && !hasInitialized) {
    const pd = profileData.data;
    if (pd.display_name) setDisplayName(pd.display_name);
    if (pd.avatar_url) setAvatar(pd.avatar_url);
